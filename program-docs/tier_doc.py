...
SECTIONS = [
    ...
    ("env",   "07 / ENVIRONMENT",    D.TEAL,   "Equipment and sourcing", "Glasses, bulbs, a router timer, water, and where to get each one.", D.environment),
    ("days",  "08 / THE NINETY DAYS", D.BLUE,  "Three phases",        "Stop the drain. Recharge. Build. Measured at both ends.", D.ninety),
    ("check", "09 / EVERY DAY",      D.NAVY,   "Daily checklist",     "This is what goes in the log. Under a minute.", D.checklist),
]
...
<p><b>Coherence</b> is the ability of cells to hold their proper electrical identity while coordinating their voltage, metabolism, timing and behavior with the tissue around them and with the whole organism. A cell can be individually healthy and still be out of step with its neighbours. That is what the ninety days are for.</p>
